...
////////// Network Configuration //////////
    ...
    const IPAddress excludedHosts[] = {
        // IPAddress(192, 168, 1, 10),  // example: Authorized RSLogix/FactoryTalk PC
    };
    ...
    const IPAddress excludedPLCs[] = {
        // IPAddress(192, 168, 1, 20),  // example: Life safety PLC
    };

////////// Monitoring Configuration (Defaults Recommended) //////////
